...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant__ = __webpack_require__(67);
...
function UserList(_ref) {
    ...
    var usersElements = users.map(function (user) {
        return _react2.default.createElement(
            'li',
            { key: user.id },
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(23),B=__webpack_require__(4),C=__webpack_require__(5),ba=__webpack_require__(24),da=__webpack_require__(25),ea=__webpack_require__(26),fa=__webpack_require__(27),ia=__webpack_require__(28),D=__webpack_require__(10);
...
var _Registration = __webpack_require__(85);
...
var _HeaderWrapper = __webpack_require__(93);

var _HeaderWrapper2 = _interopRequireDefault(_HeaderWrapper);

var _Users = __webpack_require__(94);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_HeaderWrapper2.default, null),
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Password:',
                        _react2.default.createElement('input', { name: 'hash', type: 'text', value: this.state.hash, onChange: this.handleChange })
                    ),
...
var Registration = function (_React$Component) {
    ...
    _createClass(Registration, [{
        ...
        value: function onRedirect() {
            if (this.state.redirect) return _react2.default.createElement(_reactRouterDom.Redirect, { to: './login' });
        }
    }, {
        key: 'onError',
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    'FirstName:',
                    _react2.default.createElement('input', { name: 'firstName', type: 'text', value: this.state.firstName, onChange: this.handleChange })
                ),
                _react2.default.createElement(
                    'label',
                    null,
                    'SecondName:',
                    _react2.default.createElement('input', { name: 'secondName', type: 'text', value: this.state.secondName, onChange: this.handleChange })
                ),
                _react2.default.createElement(
                    'button',
    ...
    _createClass(Feed, [{
        ...
        value: function getPosts() {
            ...
            fetch('./feed').then(function (response) {
                ...
                _this2.setState({ data: responseData });
            });
        }
    }, {
        key: 'loading',
        value: function loading() {
            if (this.state.data[0]) {
                return _react2.default.createElement(_PostList2.default, { posts: this.state.data });
...
var _PostAuthor = __webpack_require__(88);
...
var Post = function (_React$Component) {
    ...
    function Post(props) {
        ...
        _this.getAuthor = _this.getAuthor.bind(_this);
    ...
    _createClass(Post, [{
        ...
        value: function getAuthor() {
            ...
            fetch('./users/' + this.state.user_id).then(function (response) {
                return response.json();
            }).then(function (data) {
        ...
        value: function loadUser() {
            if (this.state.userData) {
                return _react2.default.createElement(_PostAuthor2.default, { user: this.state.userData });
            } else return _react2.default.createElement(
                'div',
                null,
                'loading...'
...
var PostAuthor = function (_React$Component) {
    ...
    function PostAuthor(props) {
        ...
        var _this = _possibleConstructorReturn(this, (PostAuthor.__proto__ || Object.getPrototypeOf(PostAuthor)).call(this, props));
...
var _FriendsPlace = __webpack_require__(90);

var _FriendsPlace2 = _interopRequireDefault(_FriendsPlace);

var _PostPlace = __webpack_require__(92);

var _PostPlace2 = _interopRequireDefault(_PostPlace);
    ...
    _createClass(Profile, [{
        ...
        value: function getUserPage() {
            ...
            fetch('/me').then(function (res) {
                ...
                var status = void 0;
                if (usr.posts && usr.user.created_at) status = 'me';else if (usr.posts) status = 'friend';else {
                    status = 'other';
                }
                _this2.setState({ data: usr, status: status });
            });
        }
    }, {
        key: 'onUserLoad',
        value: function onUserLoad() {
            return _react2.default.createElement(
                'h4',
                null,
                JSON.stringify(this.state.data.user) || ' '
            );
        }
    }, {
        key: 'postsValidate',
        value: function postsValidate() {

            if (this.state.status === 'me' || this.state.status === 'friend') return _react2.default.createElement(_PostPlace2.default, { posts: this.state.data.posts, noAuthor: true });
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                null,
                this.onUserLoad(),
                _react2.default.createElement(_FriendsPlace2.default, null),
                this.postsValidate()
            );
        }
    }]);
...
var FriendsPlace = function (_React$Component) {
    _inherits(FriendsPlace, _React$Component);

    function FriendsPlace(props) {
        _classCallCheck(this, FriendsPlace);

        var _this = _possibleConstructorReturn(this, (FriendsPlace.__proto__ || Object.getPrototypeOf(FriendsPlace)).call(this, props));
    ...
    _createClass(FriendsPlace, [{
        ...
        value: function getUserFriends() {
            ...
            fetch('./me/friends').then(function (req) {
                return req.json();
        ...
        key: 'onFriendsLoad',
        value: function onFriendsLoad() {
            var arr = this.state.friends;

            return _react2.default.createElement(_UserList2.default, { users: arr });
        }
    }, {
        key: 'render',
        value: function render() {
...
var PostPlace = function (_React$Component) {
    _inherits(PostPlace, _React$Component);

    function PostPlace(props) {
        _classCallCheck(this, PostPlace);

        var _this = _possibleConstructorReturn(this, (PostPlace.__proto__ || Object.getPrototypeOf(PostPlace)).call(this, props));

        _this.state = { posts: props.posts || [] };

        //  this.getUserPosts = this.getUserPosts.bind(this)
        _this.onPostsLoaded = _this.onPostsLoaded.bind(_this);
        return _this;
    }
...
var HeaderWrapper = function (_React$Component) {
    ...
    function HeaderWrapper(props) {
        ...
        var _this = _possibleConstructorReturn(this, (HeaderWrapper.__proto__ || Object.getPrototypeOf(HeaderWrapper)).call(this, props));
    ...
    _createClass(HeaderWrapper, [{
        ...
        key: "getValidationsStatus",
        value: function getValidationsStatus() {
            var _this2 = this;
            ...
            fetch('/validate', {
                ...
                if (res.status === 401) {
                    _this2.setState({ validate: false });
                } else {
                    _this2.setState({ validate: true });
                }
            });
        }
    }, {
...
exports.default = (0, _reactRouter.withRouter)(HeaderWrapper);
...
var Users = function (_React$Component) {
    ...
    _createClass(Users, [{
        ...
        key: 'onUsersLoad',
        value: function onUsersLoad() {
            return _react2.default.createElement(_UserList2.default, { users: this.state.users });
        }
    }, {
        key: 'finder',
        value: function finder(limit, offset) {
            return _react2.default.createElement(
                'form',
                null,
                _react2.default.createElement(
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__withRouter__ = __webpack_require__(83);
